# BAZZ.AGENT 项目状态交接（v1.5.46 仓位算法 SMC 风险口径重设计 · 2026-09-13 更新）
...
- **当前版本**：**v1.5.46（仓位算法按 SMC 重设计：结构定止损 · 距离从入场价算 · 风险预算反推仓位）**；
  `package.json` 与最新 git tag 均为 v1.5.46
