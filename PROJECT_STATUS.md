# BAZZ.AGENT 项目状态交接（v1.5.32 · 2026-09-12 更新）
...
>
> ⚠️ 上一版本文档停留在 v1.5.3 / 表格到 v1.5.11，与代码实际差 18 个版本。**本文档已按 v1.5.32 全量校准。**
...
- **当前版本**：**v1.5.32**（`package.json` 与最新 git tag 一致）
...
- **v1.5.31**（HEAD `e4ac25c`）已提交、打 tag 并推送；**v1.5.32** 的改动已完成（见 §二 表格首行）
- 7 个离线回归套件**全部通过**：test_v150_market ✓ · test_v151_radar_track ✓ ·
  ...
  test_v1531_prompt_fixes 14/14 · test_v1532_proxy_kernel_state 12/12 ✅
- 上一版本文档（停留在 v1.5.3 / 表格到 v1.5.11）已按 v1.5.32 全量重写；`RELEASE_NOTES.md`
  版本顺序已整理为严格降序，且已模拟 CI 截取校验（v1.5.32 小节 75 行、无历史版本标题渗入）
