# BAZZ.AGENT 项目状态交接（v1.5.38 代理池回退到 v1.5.35 行为 · 2026-09-12 更新）
...
- **当前版本**：**v1.5.38（代理池整体回退到 v1.5.35 的行为：恢复开机自动连代理 / 面板即时渲染 / 连接同步等待；只保留「取消连接真的断开」这一条修复）**；
  `package.json` 与最新 git tag 均为 v1.5.38
