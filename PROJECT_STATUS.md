# BAZZ.AGENT 项目状态交接（v1.5.40 广场文章四风格库 + 消息面 + 仓位口径修正 · 2026-09-12 更新）
...
- **当前版本**：**v1.5.40（广场文章四种风格轮换 + scanner.coin_news 代币消息面 + 仓位算法改「本金=保证金、名义=本金×杠杆」口径）**；
  `package.json` 与最新 git tag 均为 v1.5.40
