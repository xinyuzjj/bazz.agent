# BAZZ.AGENT 项目状态交接（v1.5.65 剧本进度带游标修补 · 2026-09-16 更新）
...
>
> ⚠️ 上一版本文档停留在 v1.5.47，与代码实际差 14 个版本。**本文档已按 v1.5.65 全量校准（2026-09-16）。**
...
- **当前版本**：**v1.5.65（剧本进度带游标挪进高亮框内 —— 修掉「当前格=吸筹」时游标压住表头的叠字）**；
  `package.json` 与最新 git tag 均为 v1.5.65
